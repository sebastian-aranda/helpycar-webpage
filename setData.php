...
if (isset($_GET["dispositivo"]) && isset($_GET["id_local"]) && isset($_GET["nota"]) && !isset($_GET["update"])){
	...
	$result = mysql_query("UPDATE calificacion SET nota = ".htmlspecialchars($_GET["nota"])." WHERE dispositivo = '".htmlspecialchars($_GET["dispositivo"])."' AND id_local = ".htmlspecialchars($_GET["id_local"]).";");
	...
	$result = mysql_query("INSERT INTO oferta(id_local, oferta, precio) VALUES (".$_POST["id_local"].", ".htmlspecialchars($_POST["precio"]).", '".htmlspecialchars($_POST["producto"])."')");
	...
	$result = mysql_query("INSERT INTO denuncia(id_local, comentario) VALUES (".$_POST["id_local"].", '".htmlspecialchars($_POST["comentario"])."')");
