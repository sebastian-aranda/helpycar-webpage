$(function() {
    ...
    $("#agregar-rubro").on("click", function(){
        ...
        if (id_rubros_selected.indexOf(id_rubro_selected) != -1){
        ...
        if (rubrosPremium[premium] > qRubros_selected){
            ...
            alert("Para poder agregar mas rubros cambie su membresia a una premium mayor");
    });
